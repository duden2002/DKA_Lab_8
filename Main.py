        ...
        if validation_of_data(self.tableWidget):
            ...
            while i < self.tableWidget.rowCount():
                ...
                try:
                    ...
                    tan_sum_of_k_i = math.tan(sum_of_k_i) # Высчитывание знаменателя
                    radical_and_sum_item_and_item_minus_1 = ((int(item) ** 2) + (int(item_minus_1) ** 5)) ** (1 / 3.0)   # Высчитывание числителя с корнем

                    answer = radical_and_sum_item_and_item_minus_1 / tan_sum_of_k_i
